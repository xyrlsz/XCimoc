...
public class RxEvent {
    ...
    // 检查更新服务事件
    public static final int EVENT_CHECK_UPDATE_PROGRESS = 131;
    public static final int EVENT_CHECK_UPDATE_COMPLETE = 132;
    public static final int EVENT_CHECK_UPDATE_FAIL = 133;

    // 导出服务事件
    public static final int EVENT_EXPORT_RESULT = 161;
    ...
    @IntDef({EVENT_COMIC_FAVORITE, EVENT_COMIC_UNFAVORITE, EVENT_COMIC_READ, EVENT_COMIC_UPDATE, EVENT_COMIC_FAVORITE_RESTORE,
            ...
            EVENT_CHECK_UPDATE_PROGRESS, EVENT_CHECK_UPDATE_COMPLETE, EVENT_CHECK_UPDATE_FAIL, EVENT_EXPORT_RESULT})
